                  ...
                  <DialogContent className="sm:max-w-[720px] max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">Registre primeiro o que o aluno já consegue para planejar os próximos passos (ZDP).</p>
                      </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <p className="text-xs text-muted-foreground">Escolha em que ponto o caso está e se seguirá ou não em acompanhamento pela equipe.</p>
                      ...
                      <div className="grid gap-2">
                        ...
                        >
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-xs text-muted-foreground font-normal">Registra disparo na timeline.</p>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-xs text-muted-foreground font-normal">Registra a tentativa na timeline.</p>
                          </div>
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-xs text-muted-foreground font-normal">Registra envio na timeline.</p>
                          </div>
                        </Button>
                      </div>
                    </div>
        ...
        {!isInTriage && (
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground pt-1">O PEI é elaborado e registrado no sistema (avaliação psicopedagógica), não por upload.</p>
              <div className="pt-2">
